...
describe("Merkle Trees", function () {
    it("Should be able to verify if address is in whitelist or not", async function () {
        ...
        console.log('tst adds',testAddresses.address);
        const list = [
        ...
        console.log(`M tRee ${merkleTree}`, 'on line no 39');
        ...
        for (let i = 0; i < 6; i++) {
            ...
            console.log('v invl', await connectedWhitelist.checkInWhitelist(proof, 2));
